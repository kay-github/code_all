...
function buildStockSnapshot(input = {}) {
  ...
  const allowedComputedSources = partitionedSourcePolicy
  ...
  if (!partitionedSourcePolicy && computedSources.length > 1) {
  ...
  return {
    ...
    quality: {
      ...
      coverage,
      computedSources: {
        policy: partitionedSourcePolicy ? "exchange-partitioned.v1" : "legacy-single-source.v1",
